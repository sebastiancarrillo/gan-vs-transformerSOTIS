...
def get_args():
    ...
    parser.add_argument('--patch-size', '-ps', dest='patch_size', type=int, default=24, help='Batch size')
    ...
    parser.add_argument('--log_path', type=str, default='/media/Data/sebasModels/modelosComparacion', help='path to save logging files and images')
    ...
    for epoch in range(0,1000000):
        ...
        for data in train_loader:
            ...
            if iter_count>0 and iter_count % args.val_period == 0:
                print("aquiiieeeeeeeeeeeeestooooooyyyyyyyyyyyyyyyyyyy","evaluation")
